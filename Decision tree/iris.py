...
with sns.plotting_context("notebook",font_scale=1.5):
    ...
    sns.distplot(dataset["Class"].dropna(),
                 bins=20,
                 kde=False,
                 color="green")
    plt.ylabel("Class")
dataset["sepal width"].value_counts().plot(x=None, y=None, kind='pie')
boxplot1=sns.boxplot(x='sepal width', y='petal width', data=dataset)
boxplot1.set(xlabel='sepal width')
boxplot1=sns.boxplot(x='sepal length', y='petal width', data=dataset)
boxplot1.set(xlabel='sepal length')
dataset.describe()
#total rows count
