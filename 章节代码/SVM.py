...
print("数据转化中......")
transformData.trans("./data/Churn-Modelling-Test-Data.csv", "./data/Churn-Modelling-Test-DataT.csv")
transformData.trans("./data/Churn-Modelling-new.csv", "./data/Churn-Modelling-newT.csv")

print("数据预处理归一化.........")
preprocessing.prepro("./data/Churn-Modelling-Test-DataT.csv", "./data/scalar-test.csv")
preprocessing.prepro("./data/Churn-Modelling-newT.csv", "./data/scalar.csv")

print("数据选择............")
selectData.select("./data/scalar.csv", "./data/select-data.csv")
'''
print("读取训练集与测试集文件.........")
